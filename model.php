...
class Model extends Connection{ 
 ...
 public function insert_mahasiswa($id,$nama,$semester,$alamat,$no_tlp) { 
     $sql = "INSERT INTO tbl_mahasiswa (id, nama, semester, alamat, no_tlp) VALUES ('$id','$nama','$semester','$alamat','$no_tlp')"; 
      $this->conn->query($sql);
    }
  ...
  public function tampil_mahasiswa(){ 
     ...
     public function edit_mahasiswa($No){ 
        $sql = "SELECT * FROM tbl_mahasiswa WHERE id='$No'"; 
        $bind = $this->conn->query($sql); 
        while ($obj = $bind->fetch_object()){ 
        $baris = $obj; 
        } 
    ...
    public function update_mahasiswa($id,$nama,$semester,$alamat,$no_tlp){ 
        $sql = "UPDATE tbl_mahasiswa SET nama='$nama', semester='$semester', alamat='$alamat', no_tlp='$no_tlp' WHERE id='$id'"; 
        $this->conn->query($sql);
    } 
    ...
    public function insert_absen($id,$mhs_id,$matakuliah_id,$waktu_absen,$status) {
     ...
     $sql = "INSERT INTO tbl_absen (id, mhs_id, matakuliah_id, waktu_absen, status) VALUES ('$id','$mhs_id','$matakuliah_id','$waktu_absen','$status')"; 
      $this->conn->query($sql);
    }
